...
namespace move {
  ...
  const std::vector<int> blocked[] = {
    ...
    {R1, R2, R3, L1, L2, L3, R1L1, R1L2, R1L3, R2L1, R2L2, R2L3, R3L1, R3L2, R3L3, TRL, TFB, RRL, RFB},
    {F1, F2, F3, B1, B2, B3, F1B1, F1B2, F1B3, F2B1, F2B2, F2B3, F3B1, F3B2, F3B3, TRL, TFB, RRL, RFB}
  };
