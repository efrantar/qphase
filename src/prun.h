...
namespace prun {
  ...
  const int N_FS1TWIST = sym::N_FSLICE1 * coord::N_TWIST * state::N_SUMM_SYM;
  const int N_CORNUD2 = sym::N_CORNERS * coord::N_UDEDGES2 * state::N_SUMM_SYM;
  const int N_CSLICE2 = coord::N_CORNERS * coord::N_SLICE2 * state::N_SUMM_SYM;
